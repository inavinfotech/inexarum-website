...
const WHATSAPP_NUMBER = "919286070075";
const DEFAULT_MESSAGE = "Hi iNexarum! I'm interested in your services. Can we discuss my project?";
  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col items-end gap-3">
        ...
        {isTooltipVisible && (
          ...
          >
            ...
            <p className="text-sm text-gray-700 font-medium leading-snug">
              👋 Hi! Need help with your project? Chat with us now!
            </p>
            {/* Arrow */}
      ...
      <motion.a
        ...
        onMouseLeave={() => {
          if (hasShownTooltip) setIsTooltipVisible(false);
        }}
        className="relative w-11 h-11 md:w-14 md:h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 flex items-center justify-center hover:shadow-xl hover:shadow-[#25D366]/40 transition-shadow"
      >
        {/* Pulse Ring */}
